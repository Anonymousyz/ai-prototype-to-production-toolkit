...
This toolkit is informed by public materials on forward deployed engineering, enterprise AI deployment, LLM evaluation, AI observability, guardrails, responsible AI, model documentation, and human-centered AI.
...
| S6 | DeepEval | Open-source LLM evaluation framework | https://github.com/confident-ai/deepeval | Pytest-like LLM unit tests, metrics, agent/RAG evaluations |
| S7 | Arize Phoenix | Open-source AI observability/evaluation | https://github.com/Arize-ai/phoenix | Tracing, datasets, experiments, prompt management, production monitoring |
| S8 | Opik | Open-source AI observability/evaluation | https://github.com/comet-ml/opik | Tracing, LLM-as-judge, online evaluation rules, production dashboards |
| S9 | NVIDIA NeMo Guardrails | Open-source guardrails toolkit | https://github.com/NVIDIA-NeMo/Guardrails | Programmable guardrails, safety, secure tool/service connection, vulnerability scanning |
| S10 | Guardrails AI | Open-source guardrails framework | https://github.com/guardrails-ai/guardrails | Input/output guards, validators, structured output validation |
...
| ID | Source | Type | URL/path | Notes |
|---|---|---|---|---|
| B1 | OpenAI Careers: Forward Deployed Engineer roles | Official company careers | https://openai.com/careers/ | Role pattern for FDE / Gov-FDE |
| B2 | Anthropic Careers: Forward Deployed Engineer, Applied AI | Official company careers | https://www.anthropic.com/careers/ | Applied AI / deployment role pattern |
| B3 | Palantir Forward Deployed AI Engineer role | Official company careers | https://jobs.lever.co/palantir/ | FDE origin-style role pattern |
| B4 | Caixin article on FDE demand | Media | Local source, not reproduced here | Background only; repository does not reproduce paid/proprietary content |

## Evidence note

This repository does not copy proprietary job descriptions or paid content. It synthesizes public role patterns and open-source project patterns into a practical deployment-readiness toolkit.
